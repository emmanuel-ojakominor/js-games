  ...
  for (var i = 0, len = squares.length; i < len; i++) {
    (function(index) {
        ...
        squares[i].onclick = function() {
            ...
            // If the square below your current square is taken (ie., has class name of 'taken'), then you can go on top of it 
            if(squares[index + 7].classList.contains('taken')) {
                ...
                // If the square below your current square is not taken (i.e., doesn't have class name 'taken'), you can't go here.
...
// Add click eventListener to each square that will trigger the checkBoard function on click.
// This means the function will run every time you press on a square in the div grid.
